  ...
  public class ApplicationDbContext : IdentityDbContext<User, IdentityRole, string>
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<Product>().HasData(
        ...
        new Product { ProductId = 4, Name = "Hoppy Sindile", Description = "Hoppy Sindile is a delightful wooden sculpture of a kangaroo in mid-hop, expertly carved from a single piece of rich, Walnut wood. The artist’s attention to details brings the marsupial to life, from the powerful hind legs to the joyful, carefree expression.", Price = 1750.00m, ImageSrc = "https://iili.io/diXdIGS.png", CategoryId = 1 },
        ...
        new Product { ProductId = 10, Name = "Curios Curlew", Description = "Curios Curlew is a delightful wooden sculpture of a bird with its long nose, expertly carved from a single piece of warm, golden wood. The artist's attention to details brings life to the bird, as it sniffs and explores its surroundings with its uniquely shaped beak.", Price = 1200.00m, ImageSrc = "https://iili.io/diXdlZQ.png", CategoryId = 1 },
        new Product { ProductId = 11, Name = "Bombastic Glance", Description = "Bombastic Glance is a captivating wooden sculpture of a partridge bird, expertly carved from a single piece of warm, golden wood. The artist's attention to details brings the bird to life, as it turns its head away, lost in thought.", Price = 1600.00m, ImageSrc = "https://iili.io/diXd1nV.png", CategoryId = 1 },
        ...
        new Product { ProductId = 13, Name = "Sightless Peace", Description = "Sightless Peace is a thought-provoking wooden sculpture of a doll with no eyes. Carved from a single piece of smooth, pale wood. The artist’s attention to details brings the doll to life, despite its lack of eyes, conveying a sense of peacefulness and inner sight.", Price = 1150.00m, ImageSrc = "https://iili.io/diXdVF1.png", CategoryId = 1 },
